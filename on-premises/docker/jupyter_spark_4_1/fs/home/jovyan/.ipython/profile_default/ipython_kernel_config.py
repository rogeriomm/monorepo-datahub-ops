...
#  Choices: any of ['agg', 'auto', 'cairo', 'gtk3', 'gtk3agg', 'gtk3cairo', 'gtk4', 'gtk4agg', 'gtk4cairo', 'inline', 'ipympl', 'macosx', 'nbagg', 'notebook', 'osx', 'pdf', 'pgf', 'ps', 'qt', 'qt5', 'qt5agg', 'qt5cairo', 'qt6', 'qtagg', 'qtcairo', 'svg', 'template', 'tk', 'tkagg', 'tkcairo', 'webagg', 'widget', 'wx', 'wx', 'wxagg', 'wxcairo'] (case-insensitive) or None
#  Default: None
...
#  matplotlib backend and loop integration. The exact options available depend on
#  what Matplotlib provides at runtime.
#  Choices: any of ['agg', 'auto', 'cairo', 'gtk3', 'gtk3agg', 'gtk3cairo', 'gtk4', 'gtk4agg', 'gtk4cairo', 'inline', 'ipympl', 'macosx', 'nbagg', 'notebook', 'osx', 'pdf', 'pgf', 'ps', 'qt', 'qt5', 'qt5agg', 'qt5cairo', 'qt6', 'qtagg', 'qtcairo', 'svg', 'template', 'tk', 'tkagg', 'tkcairo', 'webagg', 'widget', 'wx', 'wx', 'wxagg', 'wxcairo'] (case-insensitive) or None
#  Default: None
...
## The date format used by logging formatters for `logging.Formatter` ``datefmt``
#  parameter
#  Default: '%Y-%m-%d %H:%M:%S'
...
#  
#  This should allow easy reuse of the IPKernelApp entry point to configure and
...
## Set to False if you want to debug kernel modules.
#  Default: True
# c.Kernel.filter_internal_frames = True
...
#  Default: "Python 3.13.14 | packaged by conda-forge | (main, Jun 12 2026, 09:50:25) [GCC 14.3.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.15.0 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.13.14 | packaged by conda-forge | (main, Jun 12 2026, 09:50:25) [GCC 14.3.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.15.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#  Choices: any of ['Context', 'Plain', 'Verbose', 'Minimal', 'Docs', 'Doctest'] (case-insensitive)
#  Default: 'Context'
...
# c.ZMQInteractiveShell.banner1 = "Python 3.13.14 | packaged by conda-forge | (main, Jun 12 2026, 09:50:25) [GCC 14.3.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.15.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.ZMQInteractiveShell.system_raise_on_error = False
